...
function drawChart() {
   ...
   dataTable.addRows([
      ...
      [ new Date(2020, 9, 11), 37032 ],
      [ new Date(2020, 9, 12), 37032 ],
      [ new Date(2020, 9, 13), 37032 ],
      [ new Date(2020, 9, 14), 37032 ],
      [ new Date(2020, 9, 15), 37032 ],
      [ new Date(2020, 9, 16), 37032 ],
      [ new Date(2020, 9, 17), 37032 ],
      [ new Date(2020, 9, 18), 37032 ],
      [ new Date(2020, 9, 19), 37032 ],
      [ new Date(2020, 9, 20), 37032 ],
       ]);
